...
// CloseAPP
import ca1 from '../assets/work/closeapp/ca1.png'
...
const workItems = [
    {
        ...
        role: 'Frontend',
        projectDescription: [
            'CloseAPP - Audio Based Social Media Platform.',
            'CloseAPP is a location based audio primary platform to bring people closer who are in each other’s vicinity in the offline world. ie: People around us. CloseApp aims to empower people to discuss, interact, raise voices on key issues together, and seek help from people around them.',
        ],
        screenshots: [
            ca1
        ]
